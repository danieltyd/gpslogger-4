...
public class GpsSimpleViewFragment extends GenericViewFragment implements View.OnClickListener {
    ...
    private Button botonRegistro , botonParada;
    ...
    private void annotate() {
        ...
        if (!preferenceHelper.shouldLogToCSV() && !preferenceHelper.shouldLogToGpx() && !preferenceHelper.shouldLogToKml()
            ...
            Toast.makeText(getActivity(), getString(R.string.annotation_requires_logging), Toast.LENGTH_SHORT).show();
            return;
        }

        new MaterialDialog.Builder(getActivity())
                .title("Ingrese nombre de la parada")
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        botonRegistro = (Button) rootView.findViewById(R.id.button2);
        ...
        botonParada = (Button) rootView.findViewById(R.id.button);
  botonParada.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
             //   Toast.makeText(getActivity(),"Parada registrada",Toast.LENGTH_SHORT).show();
                annotate();
            }
        });
